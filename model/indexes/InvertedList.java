...
public class InvertedList {
  ...
  class Bloco {
    ...
    InvertedListElement[] elementos; // sequência de dados armazenados no bloco
    ...
    public Bloco(int qtdmax) throws Exception {
      ...
      elementos = new InvertedListElement[quantidadeMaxima];
      proximo = -1;
    ...
    public byte[] toByteArray() throws IOException {
      ...
      while (i < quantidade) {
        ...
        dos.writeFloat(elementos[i].getFrequency());
        i++;
      }
    ...
    public void fromByteArray(byte[] ba) throws IOException {
      ...
      int i = 0;
      while (i < quantidadeMaxima) {
        elementos[i] = new InvertedListElement(dis.readInt(), dis.readFloat());
        i++;
      }
    ...
    public boolean create(InvertedListElement e) {
      if (full())
        return false;
      int i = quantidade - 1;
    ...
    public InvertedListElement read(int id) {
      if (empty())
        return null;
      int i = 0;
      while (i < quantidade && id > elementos[i].getId())
    ...
    public boolean update(InvertedListElement e) {
      if (empty())
        return false;
      int i = 0;
    ...
    public InvertedListElement last() {
      return elementos[quantidade - 1];
    }

    public InvertedListElement[] list() {
      InvertedListElement[] lista = new InvertedListElement[quantidade];
  ...
  public boolean create(String c, InvertedListElement e) throws Exception {

    // Percorre toda a lista testando se já não existe
    // o dado associado a esse termo
    InvertedListElement[] lista = read(c);
  ...
  public InvertedListElement[] read(String c) throws Exception {

    ArrayList<InvertedListElement> lista = new ArrayList<>();
    ...
    if (!existe)
      return new InvertedListElement[0];
    ...
    lista.sort(null);
    InvertedListElement[] resposta = new InvertedListElement[lista.size()];
    for (int j = 0; j < lista.size(); j++)
      resposta[j] = (InvertedListElement) lista.get(j);
    return resposta;
  }

  // Retorna a frequência de um determinado termo em um determinado documento
  public InvertedListElement read(String c, int id) throws Exception {
  ...
  public boolean update(String c, InvertedListElement e) throws Exception {
